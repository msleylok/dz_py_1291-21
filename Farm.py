...
""")
                    ...
                    if choice_dog_eat == "0":
                        ...
                        dog.eat(7)
                    elif choice_dog_eat == '4':
                        dog.eat(10)
                        print('Ура, ты нашёл секретную косточку! Твой '+dog.name+' очень рад!')
                    else:
...
""")
                    ...
                    if choice_cat_eat == "0":
                        ...
                        cat.eat(7)
                    elif choice_cat_eat == '5':
                        cat.eat(10)
                        print('Ура, ты нашёл секретную сметану! Твой ' + cat.name + ' очень рад!')
                    else:
                        print("Извините, в меню игры нет такого пункта")
                elif choice_cat == '3':
                    print \
...
""")
            ...
            print\
            ("""Ты нашёл секретный пункт меню!\nВозможно именно в таком домике живут зверюшки нашей маленькой фермы! :D\n
══════════════════════██════█████
═════════════════════█▒▒█═══█▒▒▒█
════════════════════█▒▒▒▒█══█▒▒▒█
══════════════════██▒▒▒▒▒▒█═█▒▒▒█
